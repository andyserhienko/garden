<?php
namespace tests\classes\fruits\pear;
...
class Pear extends TestAbstract
{
	public static function run()
	{
		...
		try
		{
			print "\r\n\r\n === Начало тестирования класса \classes\\fruits\pear\Pear === \r\n\r\n";
			
			$isStaticMethod = false;
			$testData = [new FruitPear()];
			$expectedResponses = ['integer'];
			$quantityArgumentsWhichRecivedInMockMethod = 1;
			static::test($testData,'\classes\fruits\pear\Pear','initWeight',$isStaticMethod,$quantityArgumentsWhichRecivedInMockMethod,$expectedResponses);
